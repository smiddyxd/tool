...
The processing legend is a toggle. When enabled, the ChatGPT main area is divided into one horizontal zone per processing action, with translucent vertical divider lines. Left-clicking a zone sends the corresponding processing command. Right-clicking inside a zone turns zone-click mode off. When disabled, those zones do not capture clicks.
