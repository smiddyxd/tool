...
4. Do not use Unrateable as a fallback for ambiguous but assessable Weight Loss cases.
...
- If I rated Yes, is there visible evidence that the content belongs to the Weight Loss category under the manual?
- If I rated No, am I ignoring strong visible evidence that the content belongs to the Weight Loss category?
