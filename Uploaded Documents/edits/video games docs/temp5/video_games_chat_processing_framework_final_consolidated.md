...
7. Identify the **most abstract but still maximally useful frame** for the reasoning node: generalize beyond incidental names and details, but stop before the abstraction loses the decisive mechanism, evidence relationship, or boundary that makes the precedent useful.
